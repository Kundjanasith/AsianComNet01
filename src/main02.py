...
class Network():
    def __init__(self):
        ...
        self.graph.add_edge('1','2',weight=1100)
        self.graph.add_edge('1','3',weight=1600)
        self.graph.add_edge('1','8',weight=2800)
        self.graph.add_edge('2','3',weight=600)
        self.graph.add_edge('2','4',weight=1000)
        self.graph.add_edge('3','6',weight=2000)
        self.graph.add_edge('4','5',weight=600)
        self.graph.add_edge('4','11',weight=2400)
        self.graph.add_edge('5','7',weight=800)
        self.graph.add_edge('5','6',weight=1100)
        self.graph.add_edge('6','10',weight=1200)
        self.graph.add_edge('6','13',weight=2000)
        self.graph.add_edge('7','8',weight=700)
        self.graph.add_edge('8','9',weight=700)
        self.graph.add_edge('9','10',weight=900)
        self.graph.add_edge('9','12',weight=500)
        self.graph.add_edge('9','14',weight=500)
        self.graph.add_edge('11','12',weight=800)
        self.graph.add_edge('11','14',weight=800)
        self.graph.add_edge('12','13',weight=300)
        self.graph.add_edge('13','14',weight=300)
    ...
    def run(self, t, episode):
        ...
        for s in self.switches.keys():
            ...
            # print('TAKE ACTION..........')
            for p in self.switches[s].queue:
                self.switches[s].randomForward(p,t,mode='SHORTEST')
            # print('AFTER')
            # for p in self.switches[s].queue:
            #     print('S',p)
